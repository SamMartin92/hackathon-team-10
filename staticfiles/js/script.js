...
const locations = [
  { id: 31, name: "Ashford Castle: A Fairytale Romance Amidst Emerald Beauty", coords: { lat: 53.5347, lng: -9.2814 } },
  ...
  { id: 30, name: "Castello di Ama: A Tuscan Love Affair in Every Bottle", coords: { lat: 43.5362, lng: 11.3339 } },
  { id: 28, name: "Château Margaux: Elegance and Tradition in Every Sip", coords: { lat: 45.0359, lng: -0.6689 } },
  ...
  { id: 33, name: "Fjærland: A Nordic Love Affair Amidst Glacial Serenity", coords: { lat: 61.4024, lng: 6.7387 } },
  ...
  { id: 32, name: "Neuschwanstein Castle: A Fairytale Romance in the Bavarian Alps", coords: { lat: 47.5577, lng: 10.7496 } },
  ...
  { id: 34, name: "Visby: A Medieval Romance on the Baltic Shores", coords: { lat: 57.6348, lng: 18.2948 } },
